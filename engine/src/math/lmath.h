...
#define L_PI_2 2.0f * L_PI
#define L_HALF_PI 0.5f * L_PI
#define L_QUARTER_PI 0.25f * L_PI
#define L_ONE_OVER_PI 1.0f / L_PI
#define L_ONE_OVER_TWO_PI 1.0f / L_PI_2
#define L_SQRT_TWO 1.41421356237309504880f
#define L_SQRT_THREE 1.73205080756887729352f
#define L_SQRT_ONE_OVER_TWO 0.70710678118654752440f
#define L_SQRT_ONE_OVER_THREE 0.57735026918962576450f
#define L_DEG2RAD_MULTIPLIER L_PI / 180.0f
#define L_RAD2DEG_MULTIPLIER 180.0f / L_PI
...
LINLINE f32 deg_to_rad(f32 degrees) {
    return degrees * L_DEG2RAD_MULTIPLIER;
}
...
LINLINE f32 rad_to_deg(f32 radians) {
    return radians * L_RAD2DEG_MULTIPLIER;
}
