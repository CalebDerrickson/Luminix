...
// NOTE: could use __auto_type for the temp above, but intellisense
// for VSCode flags it as an unknown type. typeof() seems to work
// just fine, though. Both are GNU extensions.
