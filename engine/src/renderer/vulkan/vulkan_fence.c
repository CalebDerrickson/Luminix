    ...
    if (!fence->is_signaled) {
        ...
        switch(result) 
        {
            case VK_SUCCESS:
                ...
                return true;
            case VK_TIMEOUT:
                LWARN("vk_fence_wait - Timed out");
                break;
            case VK_ERROR_DEVICE_LOST:
                LERROR("vk_fence_wait - VK_ERROR_DEVICE_LOST.");
                break;
            case VK_ERROR_OUT_OF_HOST_MEMORY:
                LERROR("vk_fence_wait - VK_ERROR_OUT_OF_HOST_MEMORY.");
                break;
            case VK_ERROR_OUT_OF_DEVICE_MEMORY:
                LERROR("vk_fence_wait - VK_ERROR_OUT_OF_DEVICE_MEMORY.");
                break;
            default:
                LERROR("vk_fence_wait - An unknown error has occurred.");
                break;
        }
    } else {
