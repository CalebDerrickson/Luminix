...
)
{
    ...
    lzero_memory(&color_blend_attachment_state, sizeof(VkPipelineColorBlendAttachmentState));
    ...
    LERROR("vkCreateGrpahicsPipelines failed with %s.", vulkan_result_string(result, true));
    return false;
}
