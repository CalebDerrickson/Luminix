...
)
{
    ...
    // If don't care about the old layout - transition to optimal layout (for the underlying implementation).
    if (old_layout == VK_IMAGE_LAYOUT_UNDEFINED && new_layout == VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL) {
        ...
        LFATAL("Unsupported layout transition!");
        return;
    }
...
)
{
    ...
    lzero_memory(&region, sizeof(VkBufferImageCopy));
