...
{
    // Build file name. Hard-coded to 512 to avoid dynamic allocation of arrays.
    char file_name[512];
    ...
    // Shader stage info
    lzero_memory(&shader_stages[stage_index].shader_stage_create_info, sizeof(VkPipelineShaderStageCreateInfo));
