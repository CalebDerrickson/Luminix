...
)
{
    ...
    // If coming from a previous render pass, should already be VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIONAL. Otherwise undefined.
    ...
    if(do_clear_depth)
    {
        ...
        lzero_memory(&attachment_descriptions[attachment_description_count], sizeof(VkAttachmentDescription));
